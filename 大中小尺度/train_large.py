...
def main():
    ...
    yaml_path = os.path.join(base_dir, "large", "data.yaml")
    ...
    results = model.train(
        ...
        batch=8,
        workers=0,
        project=os.path.join(project_dir, "large"),
        name="large_train",
        exist_ok=True,
    ...
    print("\n" + "=" * 80)
    print("大尺度训练完成!")
    best_model = os.path.join(project_dir, "large", "large_train", "weights", "best.pt")
