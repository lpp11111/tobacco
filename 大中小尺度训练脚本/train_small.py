...
def main():
    ...
    yaml_path = os.path.join(base_dir, "small", "data.yaml")
    ...
    results = model.train(
        ...
        batch=4,
        workers=0,
        project=os.path.join(project_dir, "small"),
        name="small_train",
        exist_ok=True,
    ...
    print("\n" + "=" * 80)
    print("小尺度训练完成!")
    best_model = os.path.join(project_dir, "small", "small_train", "weights", "best.pt")
