...
def main():
    parser = argparse.ArgumentParser(description='检查large数据集标注')
    ...
    parser.add_argument('--output', default='annotation_check_large', help='输出目录')
    ...
    dataset_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'data', 'large')
