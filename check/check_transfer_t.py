...
def main():
    ...
    models_config = {
        ...
        'scratch': {
            ...
            'classes': ['grow tobacco', 'disease tobacco', 'others'],
            'type': 'seg',
            'mapping': {0: 0, 1: 1, 2: 2},
        },
        'transfer': {
    ...
    if det_results:
        ...
        det_csv = os.path.join(output_dir, 'transfer_results_det.csv')
    ...
    if seg_results:
        ...
        seg_csv = os.path.join(output_dir, 'transfer_results_seg.csv')
