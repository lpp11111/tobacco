...
class TobaccoPredictor:
    ...
    使用方法:
        # 初始化（可选模型: large, medium, small, extra_small, finetuned）
    ...
    CLASS_NAMES = {
        ...
        'extra_small': ['healthy', 'bacterial_disease', 'fungal_disease', 'viral_disease'],
    ...
    def __init__(self, model_path: Optional[str] = None, model_type: str = 'medium',
        ...
        Args:
            ...
            model_type: 预设模型类型 ('large', 'medium', 'small', 'extra_small', 'finetuned')
...
def predict(img_path: str, model_type: str = 'medium', 
    ...
    Args:
        img_path: 图片路径
        model_type: 模型类型 ('large', 'medium', 'small', 'extra_small', 'finetuned')
        model_path: 自定义模型路径（优先于model_type）
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', default='medium', 
                       choices=['large', 'medium', 'small', 'extra_small', 'finetuned'],
                       help='模型类型')
